...
var TableInit = function () {
    ...
    oTable.QueryUrl = '/ProductionRecord/DaliyRecordListJosn' + '?rnd=' + +Math.random();
    oTable.Init = function () {
        $table.bootstrapTable({
            ...
            columns: [
                ...
                { field: "TargetTimes", title: "目标量" },
                { field: "Times", title: "生产量" },
                {
                    field: "Id",
                    title: "操作",
    ...
    oTable.queryParams = function (params) {
        var data = {
            ...
            ProductionRecordId: $("#ProductionRecordId").val(),
            Times: $("#Times").val(),
        };
        return data;
    }
...
window.operateEvents = {
    'click .delete': function (e, value, row, index) {
        if (confirm("是否删除?")) {
            $.ajax({
                type: "get",
                url: '/ProductionRecord/DaliyRecordDelete/?id=' + value + '',
